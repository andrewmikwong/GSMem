...
int l1s_pm_cmd(uint8_t num_meas,
...
int l1s_pm_resp(uint8_t num_meas, __unused uint8_t p2,
		       uint16_t arfcn)
{
	...
	//losing some precision here, get rid of the /8
	dbm=agc_inp_dbm8_by_pm(pm_level[0])/8;
/*
